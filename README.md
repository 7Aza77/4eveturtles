...
| :--- | :---: | :--- | :--- |
| `/auth/sign-up` | `POST` | Регистрация нового студента | Публичный |
| `/auth/sign-in` | `POST` | Вход и получение JWT токена | Публичный |
| `/api/v1/events/` | `GET` | Список всех мероприятий (с фильтрами) | Публичный |
| `/api/v1/events/` | `POST` | Создание нового мероприятия | Модератор/Админ |
| `/api/v1/events/:id` | `GET` | Детальная информация о мероприятии | Публичный |
| `/api/v1/events/:id` | `PUT` | Обновление мероприятия | Создатель |
| `/api/v1/events/:id` | `DELETE` | Удаление мероприятия | Создатель |
| `/api/v1/events/:id/register` | `POST` | Регистрация на мероприятие | Студент |
| `/api/v1/events/:id/unregister`| `DELETE`| Отмена регистрации | Студент |
