...
func NewPostgresDB(host, port, user, password, dbname string) (*sqlx.DB, error) {
	...
	CREATE TABLE IF NOT EXISTS organizations (
		...
		description TEXT,
		university_id VARCHAR(255) DEFAULT '',
		group_chat_link VARCHAR(512) DEFAULT '',
	...
	ALTER TABLE events ADD COLUMN IF NOT EXISTS organization_id INTEGER REFERENCES organizations(id) ON DELETE SET NULL;
	ALTER TABLE events ADD COLUMN IF NOT EXISTS group_chat_link VARCHAR(512) DEFAULT '';`
